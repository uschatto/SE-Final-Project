...
bot.on('message', (data) => {
        ...
        if("files" in data ){
                ...
                var nextStep = async function() {
                        ...
                        await fileCheck (file, user_id, file_name, filetype, permalink, function(returnValue){
                        });
                        }
                }
...
async function fileCheck(file, user_id, file_name, filetype, permalink, callback){
        var isImage;
